  ...
  <div class="first-content-item">
    ...
    <div class="content-item">
      <div class="content-inner">
        <div class="cont-head">
          <h3 class="cont-title-main">휴대폰 정보를<br /><strong class="txt-primary">입력</strong>해 주세요</h3>
        </div>
        ...
        <div class="form-box">
          ...
          <div class="form_group">
            <div class="form_item val_chk">
              <InputForm class="combobox-bottom" :option="{ placeholder: '영문, 숫자만 입력해 주세요' }" />
            </div>
            <div class="error">
              <em>영문과 숫자를 8자리 이상을 입력해 주세요.</em
              ><!--ios error txt -->
              <em>숫자 6자리 이상을 입력해 주세요.</em
              ><!--android error txt -->
            </div>
            <div class="error">
              <em>영문과 숫자를 8자리 이상을 입력해 주세요.</em
        ...
        <div class="form-box">
          ...
          <div class="form_group">
            <div class="form_item val_chk">
              <InputForm class="combobox-bottom" :option="{ placeholder: '', value: '39284848939193' }" />
            </div>
            <div class="error">
        ...
        <!-- 2025-06-10 1749538995 (정C) 알닷2차 고도화 신규 추가 됨 -->
        <div class="form-box">
          <div class="check-txt check_st">
            <input type="checkbox" id="checkbox01" name="" />
            <label for="checkbox01">eSIM으로 전환할게요</label>
          </div>
        </div>
      </div>
    </div>

    <BottomFixMenu :btnText="'휴대폰 등록하기'" :disabled="false" @click="nextPage" />
    <!--디폴트 :disabled="true"-->
    <!-- // bottom_button -->
    ...
    >
      <PopupListItem v-model="storageSelect" :option="{ name: 'select_storage' }" :ListItemData="storageList" />
    </Popup>
    <!-- // 용량 수동 선택 팝업 -->
    ...
    >
      ...
      <div class="btn-flex">
        <div v-for="(item, idx) in radioData" :key="item.id + idx" class="radio_item lined">
          <input type="radio" name="radio02" :id="item.id + idx" :value="item.value" v-model="radioSelected" />
...
const modelListIphone = ref([
  ...
  },
  {
    seriesDetail: [
      {
        seriesLabel: "기타",
        seriesList: [{ value: "iOS-none", name: "기타" }],
      },
    ],
  },
]);
...
const modelListAndroid = ref([
    ...
    seriesDetail: [
      {
        ...
        seriesList: [{ value: "Android-16", name: "Galaxy S24" }],
      },
      {
    ...
    seriesDetail: [
      {
        ...
        seriesList: [{ value: "Android-19", name: "Galaxy S24" }],
      },
      {
  ...
  },
  {
    seriesDetail: [
      {
        seriesLabel: "기타",
        seriesList: [{ value: "Android-none", name: "기타" }],
      },
    ],
  },
]);
