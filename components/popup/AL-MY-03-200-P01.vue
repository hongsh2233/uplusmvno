  ...
  <div class="auth-wrap">
    <div class="cont-head title-main">
      <h3 class="cont-title-main">
        선불 요금제<br />
        <strong class="txt-primary">기간을 연장</strong>할 수 있어요
      </h3>
    </div>
    ...
    <div class="form-box">
      <div class="title-area">
        <strong class="title">충전 금액</strong>
      </div>

      <p class="country-box">38,300원</p>
    </div>

    <div class="gray-notice-box">
      <ul class="text-list bull">
        <li>
          충전 금액은 당월 해지는 불가합니다.<br />
          취소 시 사업자 의 고객센터에 문의 하세요.
        </li>
      </ul>
    </div>
  </div>
