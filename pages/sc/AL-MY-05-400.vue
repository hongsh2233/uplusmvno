          ...
          <div class="content-item">
            <div class="content-inner">
              <Accodian :isExpanded="true">
                ...
                <template #content>
                  <CardGroup :card-object="cardObject_2" @onClickChip="onClickHandler" />
                  <!-- <CardGroup :card-object="cardObject_2" @onClickChip="onClickHandler" /> -->
                </template>
              </Accodian>
            </div>
...
const cardObject_2 = ref([
  {
    ...
    url: "",
    bottomButtons: [
      { name: "변경하기", type: "outline-gray", bottomButtonClickHandler },
      { name: "해지하기", type: "outline-red", bottomButtonClickHandler },
    ],
    list: [
