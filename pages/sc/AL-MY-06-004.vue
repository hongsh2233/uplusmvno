    ...
    <div class="content" id="content">
      ...
      <div class="crp_wrap">
        ...
        <div class="crp_r">
          ...
          <div class="content-item">
            <div class="content-inner">
              ...
              <ul class="text-list bull text-list-content">
                ...
                <li>
                  단, 정당한 사유가 있을 경우, 각 파트너사 고객센터를 통해서 이용정지를 추가로 신청하실 수 있습니다.
                </li>
                <li>요금이 연체된 경우, 직접 일시정지를 해제할 수 없으니 각 파트너사 고객센터로 문의하세요.</li>
                <li>알닷케어 미제공 파트너사의 회선은 해당 고객센터를 통해 일시정지/해제 신청을 할 수 있습니다.</li>
              </ul>
            </div>
          </div>
          ...
          <BottomFixMenu :btnText="buttonInfo.btnText" :disabled="buttonInfo.activate" @click="nextPage" />
          ...
          <Accodian title="꼭 알아두세요!" styleClass="acco-notice" :isExpanded="true">
            <template #content>
              ...
              <ul class="text-list bull">
                ...
                <li>일시정지를 신청하면 최초 30일 동안은 음성통화 수신과 음성사서함만 이용하실 수 있어요.</li>
                <li>일시정지 서비스를 이용하면 부가세 포함 기본 요금이 부과돼요.</li>
                <li>이용 중이던 요금제의 기본료는 일시정지하기 전까지 사용 한 일자에 따라 계산돼요.</li>
                <li>일시정지 중에는 이용 중인 요금제와 부가 서비스를 변경할 수 없으며, 해당 요금도 발행하지 않아요.</li>
                <li>
                  일시정지 기간에도 수신자 부담 전화를 받는 경우 요금이 발생할 수 있어요. 원치 않으면 ‘수신 금지’
                  서비스를 함께 신청해 주세요.
                </li>
                <li>휴대폰 분실 등록을 한 뒤 일시정지를 하지 않으면 이용 중이던 요금이 그대로 발생돼요.</li>
                <li>선불 요금제를 이용하는 경우, 일시정지 신청이 불가합니다.</li>
                <li>알닷케어 미제공 파트너사의 회선은 해당 고객센터를 통해 일시정지를 신청할 수 있습니다.</li>
              </ul>
              <p class="text-list-tit">일시정지 해제</p>
              <ul class="text-list bull">
                <li>요금이 연체된 경우, 홈페이지에서는 일시정지를 해제할 수 없습니다. 고객센터로 문의해 주세요.</li>
        ...
        <AlertV2
          ...
          :textData="{
            title: '일시정지 신청 시,<br/> <span>사용중인 친구추천 제공량 명칭</span><br/> 제공 혜택은 즉시 사라져요',
        ...
        <AlertV2
          ...
          :textData="{
            title: '일시정지 신청 시,<br/> <span>데이터 프리덤</span><br/> 제공 혜택은 즉시 사라져요',
            description: '일시정지를 신청 하시겠어요?',
          }"
          :confirm="true"
          :buttonText="{ cancel: '취소', confirm: '확인' }"
